...
def get_filters():
    ...
    while True:
        city =input("Please enter the city you woul like to explore:\n Chicago, New York,or Washington\n").lower()
        if city in cities:
            break
        else:
    ...
    while True:
        ...
        if choice == 'month':
            month = input("Please enter the month you want to explore. If you do not want to filter by month enter 'all'. \nChoices: All, January, February, March, April, May, June\n").lower()
            day = 'all'
            if month in months:
                break
            else:
            ...
            day = input("Please enter the day of the week you want to explore. If you do not want to filter by month enter 'all'. \nChoices: All, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday\n").lower()#PB
            month = 'all'
            if day in days:
                break
            else:
...
def user_stats(df, city):
    ...
    try:
        ...
        common = df['Birth Year'].mode() #This tretrieves the Common Birth Year 
        print(' ' * 40)
...
def individual_data(df):
    # Ask user if they want to see individual raw data.
    start_data = 0
    end_data = 5
...
def main():
    while True:
        ...
        restart = input("\nWould you like to restart over? Enter yes or no.\n")
